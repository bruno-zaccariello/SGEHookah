...
__all__ = ["Categoriaproduto", "Produto", "AuthUser", "Unidademedida", "Pessoa", "Endereco", "Telefone", "Tipopessoa", "Telefone"]

class Categoriaproduto(models.Model):
		pkid_categoria = models.AutoField(primary_key=True, db_column='PKID_Categoria')  # Field name made lowercase.
		nomecategoria = models.CharField(db_column='NomeCategoria', unique=True, max_length=100)  # Field name made lowercase.
		hide = models.BooleanField(db_column='HIDE',  default=0)  # Field name made lowercase.
...
class Cotacaocompra(models.Model):
    pkid_cotacao = models.AutoField(db_column='PKID_Cotacao', primary_key=True)  # Field name made lowercase.
    ...
    hide = models.TextField(db_column='HIDE',  default=0, blank=True, null=True)  # Field name made lowercase.
...
class Endereco(models.Model):
    pkid_endereco = models.AutoField(db_column='PKID_Endereco', primary_key=True)  # Field name made lowercase.
    ...
    numero = models.CharField(db_column='Numero', max_length=7, null=True, blank=True)  # Field name made lowercase.
...
class Entrega(models.Model):
    pkid_entrega = models.AutoField(db_column='PKID_Entrega', primary_key=True)  # Field name made lowercase.
    ...
    hide = models.TextField(db_column='HIDE',  default=0)  # Field name made lowercase.
...
class Formapagamento(models.Model):
    pkid_formapag = models.AutoField(db_column='PKID_FormaPag', primary_key=True)  # Field name made lowercase.
...
class Formulaproduto(models.Model):
    pkid_formula = models.AutoField(db_column='PKID_Formula', primary_key=True)  # Field name made lowercase.
...
class Itemcompra(models.Model):
    pkid_item = models.AutoField(db_column='PKID_Item', primary_key=True)  # Field name made lowercase.
...
class Itemvenda(models.Model):
    pkid_item = models.AutoField(db_column='PKID_Item', primary_key=True, max_length=45)  # Field name made lowercase.
...
class Linhavenda(models.Model):
    pkid_linhavenda = models.AutoField(db_column='PKID_LinhaVenda', primary_key=True)  # Field name made lowercase.
...
class Materiaprima(models.Model):
    pkid_materiaprima = models.AutoField(primary_key=True, db_column='PKID_MateriaPrima')  # Field name made lowercase.
...
class Movimentacao(models.Model):
    pkid_movimentacao = models.AutoField(db_column='PKID_Movimentacao', primary_key=True)  # Field name made lowercase.
    fkid_produto = models.IntegerField(db_column='FKID_Produto')  # Field name made lowercase.
...
class Pedidocompra(models.Model):
    pkid_compra = models.AutoField(db_column='PKID_Compra', primary_key=True)  # Field name made lowercase.
    fornecedor = models.CharField(db_column='Fornecedor', max_length=100, blank=True, null=True)  # Field name made lowercase.
...
class Pedidofabricacao(models.Model):
    pkid_pedidofabri = models.AutoField(db_column='PKID_PedidoFabri', primary_key=True)  # Field name made lowercase.
    fkid_produto = models.IntegerField(db_column='FKID_Produto')  # Field name made lowercase.
    fkid_usuario_alteracao = models.IntegerField(db_column='FKID_Usuario_Alteracao')  # Field name made lowercase.
    dt_cadastro = models.DateTimeField(db_column='DT_Cadastro', blank=True, null=True)  # Field name made lowercase.
    dt_alteracao = models.DateTimeField(db_column='DT_Alteracao', blank=True, null=True)  # Field name made lowercase.
...
class Pedidovenda(models.Model):
    pkid_venda = models.AutoField(db_column='PKID_Venda', primary_key=True)  # Field name made lowercase.
...
class Pessoa(models.Model):
    pkid_pessoa = models.AutoField(primary_key=True, db_column='PKID_Pessoa')  # Field name made lowercase.
    ...
    st_pessoajuridica = models.BooleanField(db_column='ST_PessoaJuridica', max_length=1, default=0)  # Field name made lowercase.
...
class Statuscompra(models.Model):
    pkid_status = models.AutoField(db_column='PKID_Status', primary_key=True)  # Field name made lowercase.
...
class Telefone(models.Model):
    pkid_telefone = models.AutoField(db_column='PKID_Telefone', primary_key=True)  # Field name made lowercase.
    fkid_pessoa = models.ForeignKey('Pessoa', models.DO_NOTHING, db_column='FKID_Pessoa', blank=True, null=True)  # Field name made lowercase.
    ddi = models.CharField(db_column='DDI', max_length=2, default=55)  # Field name made lowercase.
...
class Usuario(models.Model):
    pkid_usuario = models.AutoField(db_column='PKID_Usuario', primary_key=True)  # Field name made lowercase.
...
class Usuarioalteracao(models.Model):
    pkid_usuario_alteracao = models.AutoField(db_column='PKID_Usuario_Alteracao', primary_key=True)  # Field name made lowercase.
    dt_alteracao = models.DateTimeField(db_column='DT_Alteracao')  # Field name made lowercase.

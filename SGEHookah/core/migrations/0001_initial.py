# Generated by Django 2.0.4 on 2018-07-17 17:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('materiaprima', models.CharField(blank=True, max_length=100, null=True, verbose_name='Matéria Prima')),
                ('marca', models.CharField(blank=True, max_length=50, null=True, verbose_name='Marca')),
                ('totalestoque', models.IntegerField(verbose_name='Estoque')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hide', models.BooleanField(default=0)),
                ('fkid_categoria', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Categoriaproduto', verbose_name='Categoria')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('hide', models.BooleanField(default=0)),
                ('fkid_pessoa', models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Pessoa', verbose_name='Pessoa')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('unidademedida', models.CharField(max_length=50, unique=True, verbose_name='Unidade')),
                ('hide', models.BooleanField(default=0)),
            ],
            options={
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Unidademedida', verbose_name='Unidade de Medida'),
        ),
        ...
        migrations.AddField(
            ...
            name='fkid_formula_materia',
            field=models.ManyToManyField(through='core.Formula_materia', to='core.Materiaprima', verbose_name='Matérias Primas'),
        ),
        migrations.AddField(
            model_name='formulaproduto',
            name='fkid_produto',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Formulaproduto', verbose_name='Fórmula'),
        ),
        migrations.AddField(
            model_name='formula_materia',
            name='fkid_materiaprima',
            field=models.ForeignKey(on_delete=django.db.models.deletion.DO_NOTHING, to='core.Materiaprima', verbose_name='Matéria Prima'),
        ),
        migrations.AddField(
            model_name='endereco',
            name='fkid_pessoa',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.DO_NOTHING, to='core.Pessoa', verbose_name='Pessoa'),
        ),
    ]

# Generated by Django 2.0.4 on 2018-08-27 03:45
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('totalvenda', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Total de Venda')),
                ('dt_cadastro', models.DateTimeField(blank=True, null=True)),
                ('dt_alteracao', models.DateTimeField(blank=True, null=True)),
                ('hide', models.BooleanField(default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dt_alteracao', models.DateTimeField(blank=True, null=True)),
                ('hide', models.BooleanField(default=0)),
                ('cotacaocompra_pkid_cotacao', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Cotacaocompra', verbose_name='Cotacaocompra')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('precovenda', models.DecimalField(decimal_places=2, max_digits=10, verbose_name='Preço de Venda')),
                ('dt_alteracao', models.DateTimeField()),
                ('dt_cadastro', models.DateTimeField()),
                ('hide', models.BooleanField(default=0)),
            ],
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('quantidade', models.IntegerField(verbose_name='Quantidade a Produzir')),
                ('dt_fim_maturacao', models.DateTimeField(blank=True, null=True, verbose_name='Data Final da Maturacao')),
                ('hide', models.BooleanField(default=0)),
                ('fkid_formulaproduto', models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Formulamateria', verbose_name='Formulamateria')),
            ],
            options={
                'managed': True,
            },
        ...
        migrations.AddField(
            ...
            name='fkid_pessoa',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Pessoa', verbose_name='Pessoa'),
        ),
        migrations.AddField(
            model_name='pedidofabricacao',
            name='fkid_statusfabricacao',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Statusfabricacao', verbose_name='Statusfabricacao'),
        ),
        migrations.AddField(
            model_name='pedidofabricacao',
            name='fkid_usuario_alteracao',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='core.Usuarioalteracao', verbose_name='Usuarioalteracao'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Pedidovenda', verbose_name='Pedidovenda'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='itemvenda',
            name='pedido_venda_idpedido_venda',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Pedidovenda', verbose_name='Pedidovenda'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Pedidocompra', verbose_name='Pedidocompra'),
        ),
        migrations.AddField(
            model_name='itemcompra',
            name='statuscompra_pkid_status',
            field=models.OneToOneField(on_delete=django.db.models.deletion.CASCADE, to='core.Statuscompra', verbose_name='Statuscompra'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='core.Statuscotacao', verbose_name='Statuscotacao'),
        ),
